...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in allAuthor" :key="author.id">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li :style="{ color: 'blue', fontWeight: '500' }">{{ orwell }}</li>
        <li :style="{ color: 'blue', fontWeight: '500' }">
          ID:{{ orwell?.id }},name:{{ orwell?.name }}
        </li>
      </ul>
    </section>
  </div>
